...
注意!!!源代码中我只放了关键代码[由于大部分都是shader]你如果想要了解原理只需要看shader即可,当然如果你需要全部代码直接打开app文件夹,里面是所有源代码

如果你对我的雪地代码很感兴趣并且有什么不懂的话都可以私聊询问我,对应的exe文件请原谅我还未打包,由于更换电脑编程环境变更,配置旧的OpenGL环境和旧SDL极其费时[目前我已更新至vulkan,请耐心等待我发布vulkan版本,这次版本将是新噪声重构]
